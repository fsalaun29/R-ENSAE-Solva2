...
```
Quelle que soit la copule utilisée, nous notons que les intervalles de confiance obtenus en modèle agrégé sont bien plus resserrés autour du $SCR$ moyen que dans le cas de la formule standard. Cependant, si nous nous intéressons uniquement au calcul du $SCR$ avec la formule standard, son écart-type est légèrement plus faible lorsque l'on choisit une copule gaussienne.
