...
```{r fig.align="center", fig.cap =  "Densité de S - Copule gaussienne", fig.pos="!H"}
...
```{r fig.align="center", fig.cap = "Densité de S - Copule de Clayton", fig.pos="!H"}
...
La formule standard donne le SCR suivant:
```{r}
SCR_FS_clayton <- SCR_FS(S_i_clayton, cor(S_i_clayton)[1,2])
SCR_FS_clayton
```
